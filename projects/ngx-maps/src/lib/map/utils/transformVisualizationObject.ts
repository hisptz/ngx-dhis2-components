...
export function transformVisualizationObject(visualizationObject) {
  ...
  const mapConfiguration: MapConfiguration = {
    id: mapconfig ? mapconfig.id : '',
    name: mapconfig
      ? mapconfig.name
      : '' || visualizationObject.name
      ? visualizationObject.name
      : '',
    subtitle: mapconfig ? mapconfig.subtitle : '',
    latitude: mapconfig ? mapconfig.latitude : '',
    longitude: mapconfig ? mapconfig.longitude : '',
    basemap: mapconfig ? mapconfig.basemap : '',
    zoom: mapconfig ? mapconfig.zoom : '',
    fullScreen: mapconfig ? mapconfig.fullScreen : ''
  };
